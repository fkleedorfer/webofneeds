...
public class ArrayUtils {
    /**
     * Merges the two arrays. The specified arrays must not contain duplicate entries.
     * @param left
     * @param right
     * @return
     */
    ...
    /**
     * Combines arrays, using the nonzero value in each position if there is one. Arrays must be same length.
     * @param left
     * @param right
     * @return
     */
